...
// Checkbox owns its own boolean state and TOGGLES it on a successful
// click before firing its callback with the new value, rather than just
// notifying "something was clicked" and leaving all state to the caller -
...
namespace HyprLUI {
    ...
    class CCheckboxWidget : public CWidget {
      public:
        ...
        // set_checkbox_checked()) - does NOT fire onChange.
